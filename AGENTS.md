...
- FPVS Studio installation, Experiment Library, and first-project instructions:
  edit `fpvs-studio.qmd`; keep interface labels aligned with the documented
  release and its screenshots.
