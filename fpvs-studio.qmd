...
[Download FPVS Studio](https://github.com/zcm58/FPVS-Studio-2.0/releases/latest){.btn .btn-primary target="_blank"}

[Read the user documentation](https://zcm58.github.io/FPVS-Studio-2.0/){target="_blank"}

### 1. Download and install

1. Open the [latest release on GitHub](https://github.com/zcm58/FPVS-Studio-2.0/releases/latest){target="_blank"} and expand **Assets** if needed.
2. Download the Windows installer whose name begins with **FPVS-Studio-Setup** and ends in **.exe**. For [version 1.8.0](https://github.com/zcm58/FPVS-Studio-2.0/releases/tag/v1.8.0){target="_blank"}, this is **FPVS-Studio-Setup-1.8.0.exe**. The source-code ZIP is not the installer.
...
Use **File → Check for Updates** to look for a newer version. You can also return to the [GitHub releases page](https://github.com/zcm58/FPVS-Studio-2.0/releases/latest){target="_blank"} for installers and release notes.
