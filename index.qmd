  ...
  <div class="zm-main">
    ...
    <section class="zm-hero" aria-labelledby="zm-research-title">
      ...
      <div class="zm-art" aria-label="Brain constellation artwork">
        ...
        <div class="zm-art-caption"><span>Brain, in a different light.</span><button type="button" class="zm-motion" data-brain-motion hidden>Pause animation</button></div>
      </div>
    </section>
    <section class="zm-work" aria-labelledby="zm-work-title">
      ...
      <div class="zm-work-layout">
        ...
        <article class="zm-paper">
          ...
          <a class="zm-text-link" href="publications.html#exploring-brain-activity-in-novice-athletes-during-closed-and-open-skills-in-table-tennis">Read the paper <span aria-hidden="true">↗</span></a>
        </article>
      </div>
    </section>
